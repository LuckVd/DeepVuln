...
|任务|描述|依赖|状态|
|---|---|---|---|
|P5-01|可利用性评估增强（核心重构）|P4-05|**→ 进行中**|
|P5-01a|整合 CodeQL 数据流结果到 Phase 4|P5-01|todo|
|P5-01b|AST 调用图构建与可达性分析|P5-01|todo|
|P5-01c|污点追踪增强（反向追踪+净化器检测）|P5-01|todo|
|P5-01d|多维评分系统（可达性+用户输入+净化器）|P5-01|todo|
