...
| P2-03 | OpenCode Agent 基础框架 | P1-08 | done |
| P2-04 | 审计策略引擎（优先级计算） | P1-08 | done |
| P2-05 | Agent 任务分配器 | P2-04 | done |
| P2-06 | 第一轮：攻击面侦察 | P2-01, P2-02, P2-03 | done |
| P2-07 | 第二轮：深度追踪 | P2-06 | done |
| P2-08 | 第三轮：关联验证 | P2-07 | done |
| P2-09 | 轮次终止决策器 | P2-06, P2-07, P2-08 | done |
| P2-10 | 证据链构建器 | P2-07 | done |

### Phase 3 详细任务：环境与验证 (L4 + L5)

| 任务 | 描述 | 依赖 | 状态 |
|------|------|------|------|
| P3-01 | Dockerfile 模板库 | P1-06, P1-10 | **→ 下一步** |
...
| v0.2.2 | + Agent | 支持 AI 驱动的深度安全审计 | done | 2026-02 |
| v0.2.3 | + Strategy | 支持审计策略生成、任务分配 | done | 2026-02 |
| v0.2.4 | + Rounds | 支持多轮审计（第一轮攻击面侦察） | done | 2026-02 |
| v0.2.5 | + Deep Track | 支持第二轮深度追踪、数据流分析 | done | 2026-02 |
| v0.2.6 | + Correlation | 支持第三轮关联验证、证据链 | done | 2026-02 |
| v0.2.7 | + Termination | 支持轮次终止决策、证据链构建 | done | 2026-02 |
| v0.3 | + L3 完整 | 支持三引擎分析、多轮审计、漏洞候选 | done | 2026-02 |
| v0.5 | + L4 + L5 | 支持环境构建、PoC 生成与验证 | dev | - |
...
| **阶段** | Phase 3 - 环境与验证 |
| **当前进度** | Phase 2 已完成 |
| **下一步** | P3-01 Dockerfile 模板库 |
| **重点模块** | L4-Environment, L5-Verification |
| **完成度** | Phase 2: 100% (10/10), Phase 3: 0% (0/9) |
...
| 风险 | CodeQL 数据库构建失败 | 中 | 待解决 | 降级到 Semgrep + Agent 方案 |
