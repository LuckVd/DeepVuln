...
| 日期 | Commit | 描述 |
|------|--------|------|
| 2026-03-10 | - | docs: 创建 Phase 6 任务清单，基于 Juice Shop 扫描评估 |
| 2026-03-09 | 86a7183 | refactor(core,cli,l3): P5-05 LLM 并发配置统一化 |
| 2026-03-09 | 9205ad8 | feat(l1,cli): P5-04 攻击面检测模式重构 - 静态+LLM并行检测 |
