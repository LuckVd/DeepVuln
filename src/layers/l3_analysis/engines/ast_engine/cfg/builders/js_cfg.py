...
Implements CFG construction for JavaScript/TypeScript code.
"""
...
class JSCFGBuilder(LanguageCFGBuilder):
    ...
    def identify_basic_blocks(
        ...
        """Identify basic blocks in JavaScript function body."""
    ...
    def build_cfg_edges(
        ...
        """Build CFG edges for JavaScript basic blocks."""
        edges = []
