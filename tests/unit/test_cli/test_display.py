...
class TestDisplayFunctions:
    ...
    def test_show_fetch_result_long_message(self) -> None:
        """Test fetch result with long commit message."""
        result = {
            "success": True,
            "source_path": "/path/to/source",
            "workspace_name": "test-workspace",
            ...
            "metadata": {
                "commit_info": {
                    "short_sha": "abc12345",
                    "message": "This is a very long commit message that should be truncated when displayed in the result table",
                    "author": "Test Author",
                },
            },
        }
